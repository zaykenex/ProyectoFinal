...
class Comentarios extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('comentarios', 'required'),
			array('id_usuarios, id_tema, megusta', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_usuarios, id_tema, comentarios, fecha_pub, megusta', 'safe', 'on'=>'search'),
		);
	}
